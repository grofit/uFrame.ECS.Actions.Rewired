...
namespace ECSModules.Rewired.Controllers.Keyboard
{
    ...
    [ActionTitle("Get Modifier Key Time Unpressed")]
    [ActionDescription("Gets the modifier key time unpressed")]
    
    public class GetModifierKeyTimeUnpressed : UFAction
    {
        [In]
        ...
        public override void Execute()
        {
            ...
            TimePressed = ReInput.controllers.Keyboard.GetModifierKeyTimeUnpressed(usedKeyCode);
        }
    }
}